              ...
              <Card.Body>
                ...
                {store.jwt_token ? (
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    <button
                      onClick={() => {
                        toast.error("Inicia sesión para agendar servicios");
                      }}
                      type="button"
                      className="btn btn btn-secondary hover-effect mt-3"
                    >
                      Agendar Servicio
                    </button>
                  </div>
          ...
          <Col md={4} xs={12}>
            ...
            >
              <Card.Body>
                ...
                <Card.Text>
                  Realizamos cirugías de diversos tipos según las necesidades de
                  tu mascota.
                </Card.Text>
                <Card.Text>Algunos de nuestros servicios:</Card.Text>
                <ul>
            ...
            >
              <Card.Body>
                ...
                <ul>
                  ...
                  <li>
                    Estabilización de mascotas con cuadro clínico de estado
                    crítico
                  </li>
