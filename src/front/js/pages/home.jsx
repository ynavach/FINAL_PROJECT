...
export const Home = () => {
	...
	return (
		...
		<div className="text-center" >
			<div className="jumbotron pt-5 mt-3 " style={{background:"white"}}>
				...
				<div>
					<div className="row d-flex mt-5 mb-5">
						...
						<div className="col-sm-4 ">
							<h4  className="mt-2 pt-2"> El  mejor  equipo  del  mundo en <br></br> servicios de cuidado para mascotas <br></br> <br></br></h4>
					...
					<div className="row g-0">
						...
						<div className="col-md-8">
							<div className="card-body">
								<h2 className="card-title">Valores <br></br> <br></br></h2>
						...
						<div className="col-md-4">
							<img src={teamvet2} className="img-fluid rounded-start" alt="..."/>
						</div>	
			...
			<div className="jumbotron p-2 mt-3" style={{background:"white"}}>
				<h1 className="display-4">Adquiere nuestros Servicios</h1>
				<p className="lead"></p>
				<div>
					...
					<div className="carousel-inner">
						<div className="carousel-item active">
								...
								<div className="carousel-caption position-absolute top-0 start-0 end-0">
									<h1 className="p-0 mb-2 display-4 p-3 mb-2 bg-dark text-light fs-1 fw-bold">Porque tu mascota se lo merece</h1>
									<h2  className="p-1 mb-0 display-4 bg-dark text-light fw-bold">Simplemente te ayudamos a cuidarlos</h2>
								</div>
						</div>
					</div>
				</div>
